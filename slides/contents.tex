...
\item[J] Es gibt nicht einen einzigen Namen. Üblich sind "Ports and Adapters" oder "Hexagonal Architecture" (wobei das ein seltsamer Name ist, der nur wegen der Visualisierung des inneren Kreises als Sechseck gewählt wurde. Nicht ganz so üblich aber sehr sprechend ist "Onion Architecture".
\end{description}
}
