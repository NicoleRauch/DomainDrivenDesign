...
\item[N] Letzten Endes weiß ich aber nicht, wie ich diese falsche Abhängigkeit beseitigen kann, wenn ich mich an die Schichtenarchitektur halten will.\end{description}
}
